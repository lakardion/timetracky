      ...
      {clients.map((c) => {
        ...
        return (
          ...
          >
            ...
            <AbsoluteDeleteButton isHovering={hoveringId === c.id} onClick={createClientDeleteHandler(c.id)} />
          </li>
        );
      })}
    </ul>
    ...
    <>
      ...
      {isOpen && !clientIsLoading ? (
        <Modal onBackdropClick={handleClose}>
          <ClientEditCreateForm clientId={currentClientId} onFinish={handleClose} />
        </Modal>
      ) : null}
      {isConfirmModalOpen ? (
        <Modal onBackdropClick={handleClose}>
          <ConfirmForm body="Confirm deleting client" isConfirming={isDeleting} onCancel={handleCancelDelete} onConfirm={handleConfirmDelete} />
        </Modal>
      ) : null}
    </>
  );
