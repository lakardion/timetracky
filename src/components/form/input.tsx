import { FC, ForwardedRef, forwardRef, HTMLInputTypeAttribute, InputHTMLAttributes } from 'react';

/**
 * These require forwarding refs because of how react hook forms works..
 */
export const Input: FC<InputHTMLAttributes<HTMLInputElement>> = forwardRef((props, ref: ForwardedRef<HTMLInputElement>) => {
  return (
    <input
      {...props}
      ref={ref}
